...
const MonthlyIncone = () => {
    return (
        <div className="monthlyIncomeContainer">
            <div className="monthlyIncomeBox">
                <div className="monthlyIncomeHeading">Sales Craked</div>
                <div className="monthlyIncomeValue">
                    <div className="monthlyIncomeValueNumber">₹ 6,567.00</div>
                    <div className="monthlyIncomeValuePercent">
                        <span>
                            <BiUpArrowAlt />
                        </span>
                        <span>5.6%</span>
                ...
                <div className="monthlyIncomeSentence">
                    Compared to the previous year
                </div>
                <hr />
                <div className="monthlyIncomeAccounting">
                    <svg
                    ...
                    <div className="MonthlyincomeName">
                        <div>Accounting</div>
                        <div>July 1, 2023 - July 31, 2023</div>
                    </div>
                </div>
            </div>
            <div className="monthlyIncomeGraph">
                <BarChart
                    horizontal={true}
                    data_1={[200, 584, 343]}
                    title_1="Leads Generation"
                    bgColor_1={["#9A55FF", "#41A5FF", "#ED4D5C"]}
